...
class MainViewController: UIViewController {
    ...
    private let paddingForRotation: CGFloat = 150 //usada para "empurrar" o menu lateral mais para a esquerda quando esta fechado porque, durante a rotação ele aparece um pouco
...
extension MainViewController: SideMenuViewControllerDelegate {
    func selectedCell(_ row: Int) {
        ...
        case 1:
            // Music
            self.showViewController(viewController: UINavigationController.self, storyboardId: "AtualizacaoCadastralNavID")
        default:
            break
        }
